...
class Web:
  def __init__(self, info):
    ...
    if not(self.info.has_key('album')):
        self.info['album']="Bilinmeyen album"
    if not(self.info.has_key('title')):
        self.info['title']="Bilinmeyen sarki"
    if not(self.info.has_key('artist')):
        self.info['artist']="Bilinmeyen sanatci"
    return
  ...
  def PrintControls(self):
    ...
    <div class='info'>\n\
        ...
        <a class='cbutton' href='?action=Play'><img src='images/play.png' alt='Play' /></a>\
